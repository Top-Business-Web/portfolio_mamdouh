    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">  المشاريع {{($setting->name_en) ?? ''}}</h3>
                    <div class="">
        ...
        <div class="modal fade bd-example-modal-lg" id="editOrCreate" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="example-Modal3">بيانات المشروع</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
@section('ajaxCalls')
    <script>
        ...
        // Delete Using Ajax
        deleteScript('{{route('projects.delete')}}');
        // Add Using Ajax
        showAddModal('{{route('projects.create')}}');
        addScript();
        // Add Using Ajax
        showEditModal('{{route('projects.edit',':id')}}');
        editScript();
    </script>
@endsection