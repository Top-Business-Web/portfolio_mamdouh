                    ...
                    <div class="content-land pt-5">
                        ...
                        <div class="video-content d-flex flex-wrap">
                            <div class="d-flex">
                                <div>
                                    ...
                                    {{-- <button class="js-modal-btn btn-video" data-video-id="917828881">
                                        <i class="fa-solid fa-play"></i>
                                    </button> --}}

                                    <button class="js-modal-btn btn-video"
                                        data-video-id=""
                                        data-video-urly="{{ $landingPageData->video_link }}">
                                        <i class="fa-solid fa-play"></i>
                                    </button>


                                </div>
                                <h5 class="text-light me-3 d-flex align-items-center">{{ trans('site.start_watching_now') }}
                                </h5>
                            </div>
                        </div>
                        <div class="social-link mt-5">
                            <ul class="list-unstyled d-flex">
                                ...
                                <li>
                                    <a href="{{ $landingPageData->twitter }}" target="_blank"><i
                                            class="fa-brands fa-twitter"></i></a>
                                </li>
                                <li>
                                    <a href="{{ $landingPageData->linkedin }}" target="_blank"><i
                                            class="fa-brands fa-linkedin-in"></i></a>
                                </li>
                                <li>
                                    <a href="{{ $landingPageData->instagram }}" target="_blank"><i
                                            class="fa-brands fa-instagram"></i></a>
                                </li>
                                <li>
                                    <a href="{{ $landingPageData->tiktok }}" target="_blank"><i
                                    ...
                                    <div class="content-service d-flex" style="height: 170px">
                                        ...
                                        <div class="text-service text-light">
                                            <h3 class="mb-2 fw-bold">
                                                {{ json_decode($service->title)->{app()->getLocale()} }}</h3>
                ...
                <div class="col-md-6 col-12 d-flex justify-content-end">
                    <div>
                        <a href="{{ route('projectsIndex') }}" class="btn-start">
                            <span>{{ trans('site.latest_projects') }}</span>
                        </a>
                    </div>
                </div>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            projectButtons.forEach(function(button) {
                button.addEventListener('click', function() {
                    ...
                    var divDataP = '<div class="school-img"><img class="img-fluid" src="storage/' +
                        projectImagesArray[0] + '" alt="no image" /></div>';
                    ...
                    for (let i = 0; i < projectImagesArray.length; i++) {
                        divDataS += '<img class="img-fluid" src="storage/' + projectImagesArray[i] +
                            '" alt="no image" />';
                    }
