...
class UpdateInformationRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            "sub_description_about.ar" => "required",
            "sub_description_about.en" => "required",
            "facebook" => 'required',
            "twitter" => 'required',
            "linkedin" => 'required',
            "instagram" => 'required',
    ...
    public function messages()
    {
        return [
            ...
            "sub_description_about.ar.required" => "وصف الداخلي بالعربي ماذا عنا مطلوب",
            "sub_description_about.en.required" => "وصف الداخلي بالإنجليزي ماذا عنا مطلوب",
